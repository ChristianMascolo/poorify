  ...
  <% boolean supervisor = ((ProfileBean) session.getAttribute("Profile")).getRole() == ProfileBean.Role.OVERSEER; %>
    ...
    <section id="head">
        <div id="playlist-cover">
            <img src="<%= "files/playlist/" + playlist.getId() + ".jpg" %>" onerror="standby(this)" onclick="playPlaylist(0)">
        </div>
        <div id="info">
            <p id="type-title">
            ...
            <div id="user-line">
                <img src="<%= "files/profile/" + playlist.getHost().getId() + ".jpg" %>" onerror="standby(this)" onclick="navToUser(<%= playlist.getHost().getId() %>, true)">
        ...
        <% for(AddedBean added: order == null ? playlist.getTracklist() : playlist.getTracklist(order)) { %>
            <div class="table-line">
                ...
                <div class="title-artists">
                    <img src="<%= "files/album/" + added.getTrack().getAlbum().getId() + ".jpg" %>" onerror="standby(this)" id="album-cover" onclick="navToAlbum(<%= added.getTrack().getAlbum().getId() %>, true)">
                    <p>
                ...
                <% if(playlist.isCollaborative()) { %>
                    <div class="added-by">
                        <img src="<%= "files/profile/" + added.getUser().getId() + ".jpg" %>" onerror="standby(this)" onclick="navToUser(<%= added.getUser().getId() %>)">
